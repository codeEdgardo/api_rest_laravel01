...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/tabler.min.css') }}" media="screen" />
    <link rel="stylesheet" type="text/css" href="{{ asset('icons/all.min.css') }}" media="screen" />
...
<body>
    ...
    <script src="{{ asset('js/jquery321.min.js') }}"></script>
    <script src="{{ asset('js/popper.min.js') }}"></script>
    <script src="{{ asset('js/bootstrap4.min.js') }}"></script>
    <script src="{{ asset('js/vendor.js') }}"></script>
    <script src="{{ asset('js/adminx.js') }}"></script>
    <script src="{{ asset('js/tabler.min.js') }}"></script>
    <script src="{{ asset('icons/all.min.js') }}"></script>
